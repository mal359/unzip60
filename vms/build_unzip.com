$! BUILD_UNZIP.COM
$!
$!     UnZip 6.0 for VMS -- DCL Build procedure.
$!
$!######################################################################
$!######################################################################
$!
$!    NOTE: This BUILD_UNZIP.COM and its related builder files are quick
$!    back-ports of the builders from a later (development) version of
$!    UnZip.  These builders (and some source-code changes) add support
$!    to UnZip 6.0 for the x86_64 hardware architecture (and IA64-x86_64
$!    cross tools).
$!
$!    They also mention features, directories, and files which are
$!    not applicable to UnZip 6.0 kits.
$!
$!    Some future optional features (AES encryption, LZMA and PPMd
$!    compression, and the LIBIZZIP.OLB object library), which UnZip
$!    6.0 does not support, have been disabled unconditionally.  (Look
$!    for "XXX", below.)
$!
...
$!
$!    For the (new) TEST option, the two ZipInfo tests should fail,
$!    because those tests use command options which are missing from
$!    UnZip 6.0.  The (new) TEST_PPMD option fails completely.
$!
$!######################################################################
$!######################################################################
$!
...
$!XXX       By default, the SFX programs are built without AES_WG support.
$!XXX       Add "CRYPT_AES_WG_SFX=1" to the LOCAL_UNZIP C macros to enable
$!XXX       it.  (See LOCAL_UNZIP, below.)
...
$!XXX       By default, the SFX programs are built without LZMA support.
$!XXX       Add "LZMA_SFX=1" to the LOCAL_UNZIP C macros to enable it.
$!XXX       (See LOCAL_UNZIP, below.)
$!XXX     - Disable PPMd compression support: "NOPPMD"
$!XXX       By default, the SFX programs are built without PPMd support.
$!XXX       Add "PPMD_SFX=1" to the LOCAL_UNZIP C macros to enable it.
$!XXX       (See LOCAL_UNZIP, below.)
...
$!XXX     - Build a callable-UnZip library, LIBIZUNZIP.OLB: "LIBUNZIP"
...
$!XXX     cc 'DEF_UNX' /object = [.'dest']ICONV_MAP.OBJ ICONV_MAP.C
$!XXX     cc 'DEF_UNX' /object = [.'dest']IF_LZMA.OBJ IF_LZMA.C
$!XXX     cc 'DEF_UNX' /object = [.'dest']IF_PPMD.OBJ IF_PPMD.C
...
$!XXX         cc 'DEF_LIBUNZIP' /object = [.'dest']ICONV_MAP_L.OBJ ICONV_MAP.C
$!XXX         cc 'DEF_LIBUNZIP' /object = [.'dest']IF_LZMA_L.OBJ IF_LZMA.C
$!XXX         cc 'DEF_LIBUNZIP' /object = [.'dest']IF_PPMD_L.OBJ IF_PPMD.C
...
$     libr /object /replace 'lib_unzip' -
       ...
       [.'dest']FILEIO.OBJ, -
       [.'dest']GLOBALS.OBJ, -
$!XXX       [.'dest']ICONV_MAP.OBJ, -
$!XXX       [.'dest']IF_LZMA.OBJ, -
$!XXX       [.'dest']IF_PPMD.OBJ, -
       [.'dest']INFLATE.OBJ, -
       [.'dest']LIST.OBJ, -
       [.'dest']MATCH.OBJ, -
       [.'dest']PROCESS.OBJ, -
...
$         libr /object /replace 'lib_libunzip' -
           ...
           [.'dest']FILEIO_L.OBJ, -
           [.'dest']GLOBALS_L.OBJ, -
$!XXX           [.'dest']ICONV_MAP_L.OBJ, -
$!XXX           [.'dest']IF_LZMA_L.OBJ, -
$!XXX           [.'dest']IF_PPMD_L.OBJ, -
           [.'dest']INFLATE_L.OBJ, -
           [.'dest']LIST_L.OBJ, -
           [.'dest']PROCESS_L.OBJ, -
           [.'dest']TTYIO_L.OBJ, -
...
$$!XXX     cc 'DEF_SXUNX' /object = [.'dest']ICONV_MAP_.OBJ ICONV_MAP.C
$$!XXX     cc 'DEF_SXUNX' /object = [.'dest']IF_LZMA_.OBJ IF_LZMA.C
$$!XXX     cc 'DEF_SXUNX' /object = [.'dest']IF_PPMD_.OBJ IF_PPMD.C
...
$     libr /object /replace 'lib_unzipsfx' -
       ...
       [.'dest']FILEIO_.OBJ, -
       [.'dest']GLOBALS_.OBJ, -
$!XXX       [.'dest']ICONV_MAP_.OBJ, -
$!XXX       [.'dest']IF_LZMA_.OBJ, -
$!XXX       [.'dest']IF_PPMD_.OBJ, -
       [.'dest']INFLATE_.OBJ, -
       [.'dest']MATCH_.OBJ, -
       [.'dest']PROCESS_.OBJ, -
       [.'dest']TTYIO_.OBJ, -
