...
#    (Back-port from later UnZip version.  See DESCRIP.MMS for details.)
#
...
# Disable features which are unavailable in UnZip 6.0.  (XXX)
NOAES_WG = 1
NOLZMA = 1
NOPPMD = 1
...
#XXX ICONV_MAP=[.$(DEST)]ICONV_MAP.OBJ \
#XXX IF_LZMA=[.$(DEST)]IF_LZMA.OBJ \
#XXX IF_PPMD=[.$(DEST)]IF_PPMD.OBJ \
...
#XXX ICONV_MAP$(GCC_)=[.$(DEST)]ICONV_MAP_.OBJ \
#XXX IF_LZMA$(GCC_)=[.$(DEST)]IF_LZMA_.OBJ \
#XXX IF_PPMD$(GCC_)=[.$(DEST)]IF_PPMD_.OBJ \
...
#XXX ICONV_MAP$(GCC_L)=[.$(DEST)]ICONV_MAP_L.OBJ \
#XXX IF_LZMA$(GCC_L)=[.$(DEST)]IF_LZMA_L.OBJ \
#XXX IF_PPMD$(GCC_L)=[.$(DEST)]IF_PPMD_L.OBJ \
