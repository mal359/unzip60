...
#######################################################################
#
#    NOTE: This DESCRIP.MMS and its related builder files are quick
...
#    compression, and the LIBIZUNZIP.OLB object library), which UnZip
...
#    is tested on Alpha to verify that it works.
#
#    For the (new) TEST target, the two ZipInfo tests should fail,
#    because those tests use command options which are missing from
#    UnZip 6.0.  The (new) TEST_PPMD target fails completely.
#
#######################################################################
#######################################################################
#
#    Last revised:  2022-07-16
#
#----------------------------------------------------------------------
...
#
#
#XXX    AES_WG=1       Enable/disable AES (WinZip/Gladman) encryption
#XXX    NOAES_WG=1     support.  Specify either AES_WG=1 or NOAES_WG=1 to
#XXX                   skip the [.aes_wg] source directory test.
#XXX                   By default, the SFX programs are built without
#XXX                   AES_WG support.  Add "CRYPT_AES_WG_SFX=1" to the
#XXX                   LOCAL_UNZIP C macros to enable it.  (See
#XXX                   LOCAL_UNZIP, below.)
#
...
#
#XXX    LIBUNZIP=1     Build LIBIZUNZIP.OLB as a callable UnZip library.
#
...
#
#XXX    NOLZMA=1       Disable LZMA compression support, which is enabled
#XXX                   by default for the normal UnZip programs.  By
#XXX                   default, the SFX programs are built without LZMA
#XXX                   support.  Add "LZMA_SFX=1" to the LOCAL_UNZIP C
#XXX                   macros to enable it.  (See LOCAL_UNZIP, above.)
#
#XXX    NOPPMD=1       Disable PPMd compression support, which is enabled
#XXX                   by default for the normal UnZip programs.  By
#XXX                   default, the SFX programs are built without PPMd
#XXX                   support.  Add "PPMD_SFX=1" to the LOCAL_UNZIP C
#XXX                   macros to enable it.  (See LOCAL_UNZIP, above.)
#
